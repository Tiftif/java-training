public class StringTraining {
	...
	public static String intToString(int value) {
		...
		String intToStr = Integer.toString(value);
		return intToStr;
	}
	...
	public static char firstChar(String string) {
		...
		char varFirstChar = string.charAt(0);
		return varFirstChar;
	}
	...
	public static char lastChar(String string) {
		...
		char varLastChar = string.charAt(string.length() - 1);
		return varLastChar;
	}
	...
	public static String subString(String string, int begin, int end) {
		...
		String strPosition = string.substring(begin, end);
		return strPosition;
	}
	...
	public static String replaceChar(String string, char search, char replace) {
		...
		String varReplace = string.replace(search, replace);
		return varReplace;
	}
	...
	public static String replaceString(String string, String search, String replace) {
		...
		String replaceStr = string.replaceAll(search, replace);
		return replaceStr;
	}
	...
	public static String[] split(String string, String delimiter) {
		...
		String[] splitArray = string.split(delimiter);
		return splitArray;
	}
	...
	public static String join(String[] strings, String delimiter) {
		...
		String joinArray = String.join(delimiter, strings);
		return joinArray;
	}
}